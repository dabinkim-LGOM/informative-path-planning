...
bool Frontier::is_in_map(grid_map::Size map_size, grid_map::Index cur_index)
{
...
vector<vector<grid_map::Index> > Frontier::wfd(const grid_map::GridMap& map_, grid_map::Index pose) {	
...
void Frontier::get_neighbours(grid_map::Index n_array[], grid_map::Index position){
...
void Frontier::get_big_neighbours(int n_array[], int position, int map_width) {
...
bool Frontier::is_frontier_point(const grid_map::GridMap& map, grid_map::Index point) {
...
int Frontier::get_row_from_offset(int offset, int width) {
	return offset / width;
}

int Frontier::get_column_from_offset(int offset, int width) {
	return offset % width;	
}
